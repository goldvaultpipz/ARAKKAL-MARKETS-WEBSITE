        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-6 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4 text-gray-400">
              {/* X (Twitter) */}
              <a href="https://x.com/ArakkalMarkets" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#FF4500]" aria-label="X (Twitter)">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/arakkalmarkets" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#FF4500]" aria-label="Instagram">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/arakkalmarkets/" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#FF4500]" aria-label="Facebook">
                <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              {/* YouTube */}
              <a href="https://www.youtube.com/channel/UCzxangXPXTMpYq_ZWcUiPaQ" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-[#FF4500]" aria-label="YouTube">
